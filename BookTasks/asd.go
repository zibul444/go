...
//func main() {
//	quote_chan := grab()
//	for i := 0; i < 1; i++ { //получаем 5 цитат и закругляемся
...
var (
	...
	used             map[string]bool = make(map[string]bool) //map в котором в качестве ключей будем использовать строки,
	// а для значений - булев тип.
)
